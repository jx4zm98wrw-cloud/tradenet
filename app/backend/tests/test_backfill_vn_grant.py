...
_TM_IDS = [uuid.UUID(f"e4000000-0000-4000-8000-00000000{i:04d}") for i in range(10, 13)]
...
async def test_backfill_resolves_grant_dates(bf_seed) -> None:
    ...
    async with Session() as s:
        ...
        assert stats["updated"] == 2  # A + madrid change; B stays NULL (no-op)
    ...
    assert by_id[_TM_IDS[2]] is None  # ungranted
